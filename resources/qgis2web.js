...
map.getView().fit([11863738.024228, -719835.060032, 11992318.198449, -660353.348545], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Fasilitan Kesehatan dan Industri di Kabupaten Bekasi</h2>';
        return titleElement;
    })(),
